...
# Voyager: An Open-Ended Embodied Agent with LLMs Paper Reading and Discussion - Arize AI
...
[
AX - Generative
 Enterprise AI Engineering Platform](https://arize.com/generative-ai/) [
AX - ML & CV
 Enterprise ML Observability](https://arize.com/ml-cv-observability) [
Alyx
 AI Engineering Agent](https://arize.com/alyx/)


[
Arize Platform demo See how it works Watch video
 ![image](https://arize.com/wp-content/themes/arize-2022/images/2025/navigation/products-bg.jpg)
...
[
Courses
 Essential Arize-led courses](https://arize.com/ai-courses-and-certifications/) [
Prompt Learning
 Essentials playbook](https://arize.com/prompt-learning-playbook) [
Paper readings
 AI research insights](https://arize.com/ai-research-papers/) [
Agents hub
 AI agent evaluation](https://arize.com/ai-agents/) [
LLM Evals Hub
 LLM evaluation guide](https://arize.com/llm-evaluation) [
AI Product Manager
 AI PM learning](https://arize.com/move-fast-evaluate-confidently/)
...
[
Blog
 Get to know Arize](https://arize.com/blog/) [
Community
 Bring your questions](https://community.arize.com/) [
Events
 AI networking events](https://luma.com/arizeai) [
Video tutorials
 Hands-on video tutorials](https://www.youtube.com/@arizeai/featured)
6. Company
...
[
About
 We power the future of AI](https://arize.com/about-us) [
Careers
 Join a world class team](https://arize.com/careers/?) [
Partners
 Partner with us](https://arize.com/partners/) [
Customers
 Built with Arize AX](https://arize.com/customers)
...
[
Press
 Updates from the newsroom](https://arize.com/press/) [
Security
 We take your trust seriously](https://arize.com/trust-center/)


[
Customers See who is achieving better outcomes in production
 ![image](https://arize.com/wp-content/themes/arize-2022/images/2025/navigation/company-bg.png)
 ![image](https://arize.com/wp-content/themes/arize-2022/images/2025/navigation/company-bg-dark.png)
](https://arize.com/customers)

[](https://github.com/Arize-ai/phoenix) [Sign in](https://app.arize.com/auth/login?redirect_uri=/) [Book a demo](http://arize.com/request-a-demo/) [Get started](https://app.arize.com/auth/join)
...
Alyx
 AI Engineering Agent](https://arize.com/alyx/) [
Arize Platform demo
 See how it works](https://arize.com/resource/arize-platform-demo-2/)
2. [Phoenix OSS](https://phoenix.arize.com/)
Back
3. [Pricing](https://arize.com/pricing/)
Back
...
[Book a demo](https://arize.com/request-a-demo) [Sign in](https://app.arize.com/auth/login?redirect_uri=/) [Sign up](https://app.arize.com/auth/join)
...
Share
- [![](https://arize.com/wp-content/themes/arize-2022/images/icon-tw-circle.svg)
](//twitter.com/intent/tweet?url=https%3A%2F%2Farize.com%2Fblog%2Fvoyager-an-open-ended-embodied-agent-with-llms-paper-reading-and-discussion%2F&text=Voyager: An Open-Ended Embodied Agent with LLMs Paper Reading and Discussion)
- [![](https://arize.com/wp-content/themes/arize-2022/images/icon-fb-circle.svg)
](//www.facguide.com/sharer/sharer.php?u=https://arize.com/blog/voyager-an-open-ended-embodied-agent-with-llms-paper-reading-and-discussion/&picture=https://arize.com)
- [![](https://arize.com/wp-content/themes/arize-2022/images/icon-in-circle.svg)
](//www.linkedin.com/shareArticle?mini=true&url=https%3A%2F%2Farize.com%2Fblog%2Fvoyager-an-open-ended-embodied-agent-with-llms-paper-reading-and-discussion%2F&title=Voyager: An Open-Ended Embodied Agent with LLMs Paper Reading and Discussion)
...
[Get the latest](#blog-subscribe-modal)
...
![](https://arize.com/wp-content/uploads/2026/02/cuga-ibm-agent-open-source-cover.png)


[CUGA Agent: From Benchmarks to Business Impact of IBM’s Generalist Agent](https://arize.com/blog/cuga-agent-from-benchmarks-to-business-impact-of-ibms-generalist-agent/)
...
[CLAUDE.md: Best Practices Learned from Optimizing Claude Code with Prompt Learning](https://arize.com/blog/claude-md-best-practices-learned-from-optimizing-claude-code-with-prompt-learning/)
 ...
 content
featured image
![](https://arize.com/wp-content/uploads/2023/06/Community-papers-resources-image-673x560.png)
...
[Subscribe](#blog-subscribe-modal)
...
Copyright © 2026 Arize AI, Inc [Privacy Policy](https://arize.com/privacy-policy)
